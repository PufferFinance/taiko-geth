...
// TODO: Check if these implementation suffice the EIP-7702 requirements.
// TODO: Nice to Know: Where are these methods used?
// isAnchor is a dummy method to satisfy the TxData interface.
func (tx *SetCodeTx) isAnchor() bool { return false }
// markAsAnchor is a dummy method to satisfy the TxData interface.
func (tx *SetCodeTx) markAsAnchor() error { return nil }
