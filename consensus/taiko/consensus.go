...
var (
	...
	AnchorSelector       = crypto.Keccak256([]byte("anchor(bytes32,bytes32,bytes32,uint64,uint32)"))[:4]
	AnchorV2Selector     = crypto.Keccak256(
		[]byte("anchorV2(uint64,bytes32,bytes32,uint32,(uint8,uint8,uint32,uint64,uint32))"),
	)[:4]
